...
class DogsControllerTest < ActionController::TestCase
  ...
  test "should create dog" do
    assert_difference('Dog.count') do
      post :create, dog: { age: @dog.age, breed: @dog.breed, color: @dog.color, name: @dog.name, sex: @dog.sex, weight: @dog.weight }
    end
  ...
  test "should update dog" do
    patch :update, id: @dog, dog: { age: @dog.age, breed: @dog.breed, color: @dog.color, name: @dog.name, sex: @dog.sex, weight: @dog.weight }
    assert_redirected_to dog_path(assigns(:dog))
  end
